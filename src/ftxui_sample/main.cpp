...
// configuration step. It creates a namespace called `adara`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", adara::cmake::project_name, adara::cmake::project_version) };
